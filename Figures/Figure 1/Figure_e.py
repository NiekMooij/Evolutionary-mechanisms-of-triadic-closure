...
# ax.scatter([1, 10e0, 10e1, 10e2], [ tau_arr[i] for i in [1-1, int(10e0)-1, int(10e1)-1, int(10e2)-1] ], marker=markers[0], s=marker_size, zorder=2, edgecolor='black', linewidth=marker_linewidth, color='black')
...
save_name = os.path.join(sys.path[0], 'Figure_e.pdf')
