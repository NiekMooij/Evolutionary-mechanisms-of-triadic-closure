...
if __name__ == "__main__":
    ...
    df = pd.read_csv(os.path.join(sys.path[0], 'data_raw/random_geometric.csv'))
    ...
    df_data = pd.DataFrame(columns=['degree', 'mean', 'std', 'minimum', 'maximum'])
    ...
    df_data.to_csv(os.path.join(sys.path[0], 'data_analysed/random_geometric_data.csv'), index=False)